describe('Create questions', () => {
  ...
  it('creates a multiple choice question', () => {
    ...
    cy.get('[data-cy="create-question"]').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains('Single Choice (SC)');
    cy.get('[data-cy="select-question-type"]').click().siblings().findByText('Multiple Choice (MC)').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains('Multiple Choice (MC)');
  ...
  it('creates a KPRIM question', () => {
    ...
    cy.get('[data-cy="create-question"]').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains('Single Choice (SC)');
    cy.get('[data-cy="select-question-type"]').click().siblings().findByText('KPRIM (KP)').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains('KPRIM (KP)');
    cy.get('[data-cy="insert-question-title"]').click().type(questionTitle);
    cy.get('[data-cy="insert-question-text"]').click().type(question);
    cy.get('[data-cy="insert-answer-field"]').click().type('50%');
    cy.get('[data-cy="add-new-answer"]').click({force: true});
  ...
  it('creates a Numeric question', () => {
    ...
    cy.get('[data-cy="create-question"]').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains('Single Choice (SC)');
    cy.get('[data-cy="select-question-type"]').click().siblings().findByText('Numerisch (NR)').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains('Numerisch (NR)');
    cy.get('[data-cy="insert-question-title"]').click().type(questionTitle);
    cy.get('[data-cy="insert-question-text"]').click().type(question);
  ...
  it('creates a Free Text question', () => {
    ...
    cy.get('[data-cy="create-question"]').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains('Single Choice (SC)');
    cy.get('[data-cy="select-question-type"]').click().siblings().findByText('Freitext (FT)').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains('Freitext (FT)');
    cy.get('[data-cy="insert-question-title"]').click().type(questionTitle);
    cy.get('[data-cy="insert-question-text"]').click().type(question);
