...
describe('Create questions', () => {
  ...
  it('creates a single choice question', () => {
    ...
    cy.findByText('SC - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="question-title"]').contains('SC');
    cy.findByText('SC - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="edit-question"]').click();
  ...
  it('creates a multiple choice question', () => {
    ...
    cy.get('[data-cy="create-question"]').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains(messages.shared.SC.typeLabel);
    cy.get('[data-cy="select-question-type"]').click().siblings().findByText(messages.shared.MC.typeLabel).click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains(messages.shared.MC.typeLabel);
    ...
    cy.contains('[data-cy="question-block"]', question);
    cy.contains('[data-cy="question-block"]', questionTitle);
    cy.findByText('MC - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="question-title"]').contains('MC');
    cy.findByText('MC - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="edit-question"]').click();
    cy.get('[data-cy="sc-answer-options"]').should('have.length', 2);
  }),
  ...
  it('creates a KPRIM question', () => {
    ...
    cy.get('[data-cy="create-question"]').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains(messages.shared.SC.typeLabel);
    cy.get('[data-cy="select-question-type"]').click().siblings().findByText(messages.shared.KPRIM.typeLabel).click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains(messages.shared.KPRIM.typeLabel);
    cy.get('[data-cy="insert-question-title"]').click().type(questionTitle);
    cy.get('[data-cy="insert-question-text"]').click().type(question);
    cy.get('[data-cy="insert-answer-field"]').click().type('50%');
    cy.get('[data-cy="add-new-answer"]').click({force: true});
    ...
    cy.contains('[data-cy="question-block"]', questionTitle);
    cy.contains('[data-cy="question-block"]', question);
    cy.findByText('KPRIM - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="question-title"]').contains('KPRIM');
    cy.findByText('KPRIM - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="edit-question"]').click();
  ...
  it('creates a Numeric question', () => {
    ...
    cy.get('[data-cy="create-question"]').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains(messages.shared.SC.typeLabel);
    cy.get('[data-cy="select-question-type"]').click().siblings().findByText(messages.shared.NUMERICAL.typeLabel).click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains(messages.shared.NUMERICAL.typeLabel);
    cy.get('[data-cy="insert-question-title"]').click().type(questionTitle);
    cy.get('[data-cy="insert-question-text"]').click().type(question);
    ...
    cy.contains('[data-cy="question-block"]', questionTitle);
    cy.contains('[data-cy="question-block"]', question);
    cy.findByText('NUMERICAL - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="question-title"]').contains('NUMERICAL');
    cy.findByText('NUMERICAL - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="edit-question"]').click();
  ...
  it('creates a Free Text question', () => {
    ...
    cy.get('[data-cy="create-question"]').click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains(messages.shared.SC.typeLabel);
    cy.get('[data-cy="select-question-type"]').click().siblings().findByText(messages.shared.FREE_TEXT.typeLabel).click();
    cy.get('[data-cy="select-question-type"]').should('exist').contains(messages.shared.FREE_TEXT.typeLabel);
    cy.get('[data-cy="insert-question-title"]').click().type(questionTitle);
    cy.get('[data-cy="insert-question-text"]').click().type(question);
    ...
    cy.contains('[data-cy="question-block"]', questionTitle);
    cy.contains('[data-cy="question-block"]', question);
    cy.findByText('FREE_TEXT - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="question-title"]').contains('FREE_TEXT');
    cy.findByText('FREE_TEXT - ' + questionTitle).parentsUntil('[data-cy="question-block"]').find('[data-cy="edit-question"]').click();
