...
const IMAGE_WORKFLOWS = Object.freeze([
  ...
  },
  {
    globs: [
      ...
      'packages/util/**',
      ...ROOT_BUILD_GLOBS,
      '.github/workflows/v3_backend-docker-stg**',
    ],
  ...
  },
  {
    globs: [
      ...
      'packages/word-cloud/**',
      ...ROOT_BUILD_GLOBS,
      '.github/workflows/v3_frontend-control-docker-stg**',
    ],
    jobs: ['build-arm'],
  ...
  },
  {
    globs: [
      ...
      'packages/word-cloud/**',
      ...ROOT_BUILD_GLOBS,
      '.github/workflows/v3_frontend-manage-docker-stg**',
    ],
    jobs: ['build-arm'],
  ...
  },
  {
    globs: [
      ...
      'packages/word-cloud/**',
      ...ROOT_BUILD_GLOBS,
      '.github/workflows/v3_frontend-pwa-docker-assessment-stg**',
    ],
    jobs: ['build-arm'],
  ...
  },
  {
    globs: [
      ...
      'packages/word-cloud/**',
      ...ROOT_BUILD_GLOBS,
      '.github/workflows/v3_frontend-pwa-docker-stg**',
    ],
    jobs: ['build-arm'],
  ...
  },
  {
    globs: [
      ...
      'packages/util/**',
      ...ROOT_BUILD_GLOBS,
      '.github/workflows/v3_hatchet-worker-general-stg**',
    ],
    jobs: ['build-arm'],
  ...
  },
  {
    globs: [
      ...
      'packages/util/**',
      ...ROOT_BUILD_GLOBS,
      '.github/workflows/v3_hatchet-worker-response-processor-stg**',
    ],
    jobs: ['build-arm'],
  ...
  },
  {
    globs: [
      ...
      'packages/util/**',
      ...ROOT_BUILD_GLOBS,
      '.github/workflows/v3_olat-api-stg**',
    ],
    jobs: ['build-arm'],
  ...
  },
  {
    globs: [
      ...
      'packages/util/**',
      ...ROOT_BUILD_GLOBS,
      '.github/workflows/v3_response-api-stg**',
    ],
    jobs: ['build-arm'],
