...
2. **Build** with the checklist:
   ...
   - The floating Manage assistant launcher reserves no global Layout padding. Keep list-ending controls clear with local horizontal desktop space and only necessary compact bottom clearance.
