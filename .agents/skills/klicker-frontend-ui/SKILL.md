...
2. **Build** with the checklist:
   ...
   - Plain-text clipboard content is parsed as Markdown only when it contains Markdown link syntax; keep rich HTML and ordinary plain text on Tiptap's default paste path.
