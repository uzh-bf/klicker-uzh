...
| Learning analytics engine contract           | Run `test`, `check`, and `build` for `@klicker-uzh/analytics-engine-contract`; no Hatchet, database, services, or browser are needed                                                        |
