...
KB_GRAPH_STANDARD_GENERATION_MODEL=openai/gpt-5.6-luna
KB_GRAPH_STANDARD_CLEANING_MODEL=openai/gpt-5.6-luna
KB_GRAPH_HIGH_GENERATION_MODEL=openai/gpt-5.6-luna
KB_GRAPH_HIGH_CLEANING_MODEL=openai/gpt-5.6-luna
