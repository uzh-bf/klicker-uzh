...
(function ($, window, document, undefined) {
    ...
    $allModules.each(function () {
      ...
      module = {
        ...
        attachEvents(selector, action) {
          ...
          $(selector).on(`click${eventNamespace}`, (event) => {
            module[action]()
        ...
        get: {
          ...
          values(fields) {
            let $fields = $.isArray(fields) ? module.get.fields(fields) : $field,
              values = {}
          ...
          prompt(identifier) {
            ...
            if (settings.inline && $prompt.is(':visible')) {
              ...
              if (
                ...
                $prompt.fadeOut(settings.duration, () => {
                  $prompt.remove()
                })
              }
            }
  ...
  $.fn.form.settings = {
    ...
    rules: {
      ...
      integer(value, range) {
        let intRegExp = $.fn.form.settings.regExp.integer,
          min,
          max,
          parts
