  ...
  $.fn.popup = function (parameters) {
    ...
    $allModules.each(function () {
      ...
      module = {
        ...
        event: {
          start(event) {
            const delay = $.isPlainObject(settings.delay) ? settings.delay.show : settings.delay
            clearTimeout(module.hideTimer)
            if (!openedWithTouch) {
            ...
            const delay = $.isPlainObject(settings.delay) ? settings.delay.hide : settings.delay
            clearTimeout(module.showTimer)
        ...
        get: {
          ...
          offsetParent($element) {
            let element = $element !== undefined ? $element[0] : $target[0],
        ...
        bind: {
          ...
          touchClose() {
            ...
            $document.on(`touchstart${elementNamespace}`, (event) => {
          ...
          clickaway() {
            ...
            $document.on(`click${elementNamespace}`, (event) => {
