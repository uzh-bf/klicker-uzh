...
(function ($, window, document, undefined) {
  ...
  $.fn.shape = function (parameters) {
    ...
    $allModules.each(function () {
      let moduleSelector = $allModules.selector || '',
      ...
      module = {
        ...
        queue(method) {
          ...
          $sides.one(module.get.transitionEvent(), () => {
        ...
        set: {
          ...
          currentStageSize() {
            let $activeSide = $module.find(`.${settings.className.active}`),
        ...
        flip: {
          up() {
            ...
            if (!module.is.animating()) {
              ...
              const transform = module.get.transform.up()
          ...
          down() {
            ...
            if (!module.is.animating()) {
              ...
              const transform = module.get.transform.down()
              module.set.stageSize()
              module.stage.below()
              module.animate(transform)
            } else {
          ...
          left() {
            ...
            if (!module.is.animating()) {
              ...
              const transform = module.get.transform.left()
              module.set.stageSize()
              module.stage.left()
              module.animate(transform)
            } else {
          ...
          right() {
            ...
            if (!module.is.animating()) {
              ...
              const transform = module.get.transform.right()
              module.set.stageSize()
              module.stage.right()
              module.animate(transform)
            } else {
