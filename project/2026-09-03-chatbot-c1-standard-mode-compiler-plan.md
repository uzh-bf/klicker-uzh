...
| In progress | Integrated final review | Dispatch the integrated final reviewer over the full branch diff with the verification evidence above, then record its verdict. The goal completes with the review recorded; delivery stays withheld. |
