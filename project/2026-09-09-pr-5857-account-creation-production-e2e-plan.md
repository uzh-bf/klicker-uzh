...
Status: final_review_pending. Runtime acceptance is cleared; main owns integrated final review, ordinary task-branch push and updating the existing draft. The trusted-selector bootstrap limitation still blocks merge readiness and no successful dedicated GitHub workflow run is claimed.
