...
- [x] Static S5 package proof complete: Sol final review passed the exact integrated range through `f817a281dd25ceab33d6d13850b8e6d186911457`, and the focused spec covers desktop plus 390px and 320px reflow guards.
- [ ] S5 browser proof remains pending because the exact implementation runtime cannot start under the existing lifecycle lock.
