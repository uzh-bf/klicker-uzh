...
- [x] Final correction pass (`396069bcb`, `bddde399d`): restored direct invalidation error compatibility, rechecked group target access inside each element transaction, surfaced the 50-element UI limit, and aligned the dependent-object documentation with derived permission behavior.
