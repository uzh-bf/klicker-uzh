...
- Next: commit slice 5. Then finish gate: full check:all, adversarial review over fb58d89e2..HEAD, $security-review, $thermo-nuclear-code-quality-review, push to head, update PR body.
