...
- **Next:** commit this progress checkpoint, publish the synchronized head, and babysit fresh required CI. Stop before merge pending explicit approval.
