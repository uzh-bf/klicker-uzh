...
- **Next:** No implementation work remains. Keep the branch current with `v3` and CI green, then obtain reviewer approval and explicit merge authority.
