...
- 2026-07-23: Slice 8 implementation done. The Manage overview now requests the supported 20-thread page with the generated sort enum, merges later groups and threads by stable keys, stops polling after expansion to preserve loaded pages, and resumes polling on explicit refresh. The German and English continuation labels and Manage type check pass; browser verification will cover a course with more than 20 threads.
