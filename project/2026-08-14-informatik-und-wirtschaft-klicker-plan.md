...
- Baseline E2E repair publication: the isolated selector fix is published as open, non-draft PR #5416, and its required CI completed green, including all eight Playwright shards. It remains separate from the chatbot work and is not merged by this task.
...
- Treat #5405/#5411/#5414 as the merged runtime reference and leave closed #5406 unmerged; the baseline chat recovery E2E repair is a separate PR #5416 on `rs/fix-chat-recovery-e2e-selector`.
