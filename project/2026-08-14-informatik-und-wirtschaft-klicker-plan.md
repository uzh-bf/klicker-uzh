...
- Remaining: S2 commit, S2 review/simplification, S3 integrated verification/final review.
...
- Next action: stage the S2 provisioner, docs, and Progress changes, inspect the staged data boundary, commit them, then run the required S2 simplifier and slice review.
