...
| W5 | **Delete/tombstone** (Q7): soft-delete fence (`deletedAt`/`deletedById` from 5078), ingestion `DELETE /v1/resources/{id}` + tombstone handling, async hard cleanup, delete-guard while active ops | W2 | |
