...
- 2026-09-17 (S7 all five deliverable heads merged; two deploy gaps found and one fix in
  ...
  the worker still points at the old name. Fix: bump the PRD/STG `deploy/*/kustomization.yaml`
  digests to the images built from video-ai `main` `0bb9b2d522` (package run 35208434901;
  `video-processing-api` index `sha256:86673ebc…` published, worker still building). This
