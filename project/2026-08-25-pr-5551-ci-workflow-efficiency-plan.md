...
- Remaining: finish the exact-head hosted checks for the published head, record
  their final readback, and keep the PR description aligned.
...
- Finish the exact-head checks for the published head, record the final
