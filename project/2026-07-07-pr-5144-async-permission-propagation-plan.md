...
- Maintainer decision: approve starting conditional Slice 4 to prototype and choose the database-backed fence, durable dirty/outbox record, persistent failure sink, and recovery SLO. No production call-site conversion is authorized by this approval.
