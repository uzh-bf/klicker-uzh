...
1. **Host prerequisite**: Install [devrouter](https://github.com/rschlaefli/devrouter) ≥ 0.0.44 and set it up:
   ```bash
...
This repository pins devrouter 0.0.44. Managed profiles, introduced in 0.0.40,
