...
1. **Host prerequisite**: Install [devrouter](https://github.com/rschlaefli/devrouter) ≥ 0.1.1 and set it up:
   ```bash
...
This repository pins devrouter 0.1.1. Managed profiles, introduced in 0.0.40,
...
- Generating updated configuration does not change mounts in an existing
  container. Devrouter 0.1.1 does not support warm mount reconciliation.
...
0.1.1 release does not provide this recovery contract. The recovery performed
