...
[[ "$(shasum -a 256 "$root/util/dev-runtime.sh" | cut -d " " -f 1)" = "31c73df25e253cc2bf7aa275ee8bd09258c1fd2b6a0311fdb56e29a9f493ecf0" ]] || { echo "Recovery source changed: util/dev-runtime.sh" >&2; exit 1; }
...
[[ "$(docker exec "$app_id" sha256sum /workspaces/klicker-uzh/util/dev-runtime.sh | cut -d " " -f 1)" = "31c73df25e253cc2bf7aa275ee8bd09258c1fd2b6a0311fdb56e29a9f493ecf0" ]] || { echo "Mounted runtime helper differs from reviewed source." >&2; exit 1; }
