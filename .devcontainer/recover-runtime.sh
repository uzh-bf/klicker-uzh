...
[[ "$(shasum -a 256 "$root/util/dev-runtime.sh" | cut -d " " -f 1)" = "2870cfc62ce22c17bcb1db7728d17f9e8641554638bf97f364864dc29f50c4fd" ]] || { echo "Recovery source changed: util/dev-runtime.sh" >&2; exit 1; }
