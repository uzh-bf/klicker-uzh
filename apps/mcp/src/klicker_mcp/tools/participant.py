...
element, post a live-Q&A question). Clients should prompt before firing — we
surface that intent via docstring prominence; FastMCP tool metadata does not
expose a stable `destructiveHint` today.
"""
