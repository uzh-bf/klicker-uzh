...
const AbortSessionMutation = loadAsString('./AbortSessionMutation.graphql')
...
const ModifyUserAsAdminMutation = loadAsString('./ModifyUserAsAdminMutation.graphql')
...
const MovoImportMutation = loadAsString('./MovoImportMutation.graphql')
