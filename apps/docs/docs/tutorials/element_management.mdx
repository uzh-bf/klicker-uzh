...
Use the library search and filters together to narrow down your elements. If no results appear, clear the search or reset the filters. When the library is empty, use its creation guidance to add your first element. You can also prepare new drafts with the [KlickerUZH Assistant](/tutorials/ai_assistant/) or generate elements from course materials with [AI element generation](/tutorials/ai_element_generation/).
