...
In asynchronous activities (practice quizzes and microlearnings), all elements of a stack are shown at once. The title and description are displayed above the elements themselves. In live quizzes, the elements in a block are shown sequentially, while no title or description are defined.
