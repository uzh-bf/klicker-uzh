...
- If only one activity of a certain type is available, this page will redirect students automatically to the activity itself. Accordingly, we recommend including the **Live Quiz List** using the LTI link shown on the right so students can quickly access the **Live Quiz and Live Q&A** during the lecture.
- Activate “Skip launch page”.
