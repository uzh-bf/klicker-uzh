...
# Integration with LTI (Example: OLAT)
...
To create a KlickerUZH element, you always start by creating a new course element of the type “LTI Page”. The subsequent steps depend on the type of KlickerUZH element you would like to create (as listed below).
...
3. Leaderboard:
   ...
   - Follow the same settings as before.
