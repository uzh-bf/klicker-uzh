...
For **students**, content elements are viewed as follows, with the option of marking them as “read” (in asynchronous activities).
...
![Flashcard - Lecturer View](/img/supported_element_types/FT_lecturer.png)
