...
Lecturers can specify challenges, set prices and define custom achievements for the course. The leaderboard is a great way to motivate students to participate in the course and to reward them for their efforts and resembles one of the backbones of the gamification concept of KlickerUZH.
