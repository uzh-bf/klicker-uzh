...
While students compete on leaderboards against each other when collecting points from live quizzes, practice quizzes, and microlearnings, KlickerUZH also covers efforts to promote **collaboration** and **teamwork**. This section describes the student view of **groups** and **group activities**. To create them from the lecturer view, check out the [corresponding section](/tutorials/group_activity/).
...
<iframe
  ...
  width="100%"
  height="400"
  src="https://uzh.mediaspace.cast.switch.ch/embed/secure/iframe/entryId/0_lsdqyyc0/uiConfId/23448425/st/0"
  class="kmsembed"
  allowfullscreen
