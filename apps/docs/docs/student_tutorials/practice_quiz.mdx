...
While answering the questions, students can, if they are logged in, set **personal bookmarks** on important questions, and create their own study pool in this way. In case mistakes are spotted, a **flagging feature** offers the possibility to directly provide feedback to the lecturer.
