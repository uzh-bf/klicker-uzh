...
Microlearnings can be used as part of an e-learning, as **blended learning** components or to check the retention of certain course content. The evaluation view and statistics provide important information to the lecturer.
