...
$$
\text{points}_{\text{awarded}} = \text{multiplier} \cdot \begin{cases} 10 & \text{correct} \\ 10 \cdot \left( 1 - 2 \cdot \frac{\text{\% of wrong answers}}{\text{available answers}} \right) & \text{partially correct} \\ 0 & \text{otherwise} \end{cases}
$$

<!-- TODO: potentially it would make sense to replace this graphic by one that only jumps for integer correctness values -->

<div align="center">
  <img
    style={{ width: 600 }}
    alt="MC Grading Logic Illustration"
    src="/img_v3/19_MC_awarded_points.png"
  />
</div>
...
<div align="center">
  <img
    ...
    src="/img_v3/20_KPRIM_awarded_points.png"
  />
</div>
...
<div align="center">
  <img
    ...
    src="/img_v3/21_live_quiz_awarded_points.png"
  />
</div>
