...
:::info
For more details on the gamification concept, please refer to the [Gamification use case](/use_cases/gamification/) and the [Gamification documentation](/tutorials/gamification/).
:::
