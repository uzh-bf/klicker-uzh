...
In the spirit of open source, we welcome any good-spirited contributions to KlickerUZH (be it from institutions or individuals). It is generally a good idea to first get an orientation about the general direction of the project from the [**Roadmap**](/development).
