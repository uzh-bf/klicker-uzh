...
> **Note:** Please bear in mind that even though we strive for good response time and general support (i.e., best-effort), we do not have a dedicated support team for the project, as we are funded primarily through project-based funding.
