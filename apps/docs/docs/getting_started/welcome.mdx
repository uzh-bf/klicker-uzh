...
- Core functionalities (element library, live quiz, practice quiz, microlearning, group activity, course management, gamification) are **freely accessible** for anyone logging in to our public instance. We always reserve the right of restricting usage over a "fair" amount so that usage for other users is not restricted.
