...
Mit **Ja** bei der Entscheidung zu Lernanalysen dürfen berechtigte individuelle Lernanalysen nach einer Neuberechnung des Kurses nach der aktuellen Entscheidung alle berechtigten im Konto gespeicherten Aktivitätsdaten verwenden. Mit **Nein** werden keine individuellen Learning-Analytics-Daten verwendet; bereits erstellte individuelle Analysen werden bei der nächsten erfolgreichen nächtlichen Bereinigung physisch entfernt, während aggregierte Analysen bis zur regulären Neuberechnung bestehen bleiben. Wenn Sie die Entscheidung wieder aktivieren, können alle berechtigten gespeicherten Aktivitätsdaten wieder einbezogen werden.
