...
Mit **Ja** bei der Entscheidung zu Lernanalysen werden berechtigte individuelle Lernanalysen ab der aktuellen Einschlussgrenze ermöglicht. Mit **Nein** werden individuelle Lernanalysen sofort herausgefiltert; individuell abgeleitete Analysen werden bei der nächsten erfolgreichen nächtlichen Bereinigung physisch entfernt, während aggregierte Analysen bis zur regulären Neuberechnung bestehen bleiben. Wenn Sie die Entscheidung wieder aktivieren, beginnt die Berücksichtigung erst mit späteren Aktivitäten; eine rückwirkende Einbeziehung früherer Aktivitäten erfolgt nicht.
