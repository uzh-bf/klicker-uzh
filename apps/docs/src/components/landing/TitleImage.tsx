            ...
            <div className="relative px-6 py-12 sm:py-32 md:py-24 lg:px-8 lg:py-48 lg:pr-0">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                <div className="mb-8 sm:mb-10 sm:flex">
                  <div className="relative rounded-full bg-gradient-to-r from-red-50 to-orange-50 px-4 py-2 text-sm leading-6 text-gray-700 ring-1 ring-red-200 transition-all hover:ring-red-300">
                    <span className="font-semibold text-red-600">NEW:</span>{' '}
                    Anonymous Gamification & Enhanced Activity Management
                    <a
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Transform your classroom with real-time quizzes, collaborative
                  activities, and gamified learning experiences. Engage every
                  student, whether they're in-person or remote.
                </p>
                ...
                <div className="mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:gap-6">
                  <a href="https://manage.klicker.uzh.ch" target="_blank">
                    <Button
                      primary
                      className={{
                        root: 'border-none px-8 py-3 text-lg shadow-lg transition-shadow hover:shadow-xl',
                      }}
                  ...
                  <a
                    ...
                    className="text-lg font-semibold leading-6 text-gray-900 transition-colors hover:text-red-600"
                ...
                <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 shadow-sm">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm">
                      ...
                      <span className="text-blue-700">
                        {' '}
                        Regular introductory courses through UZH Central IT.{' '}
                      </span>
                      <a
                        target="_blank"
