import { faGraduationCap, faUsers, faChartLine, faStar } from '@fortawesome/free-solid-svg-icons'
...
const testimonials = [
  {
    content: "KlickerUZH transformed my large lectures. The anonymous participation feature encourages even shy students to engage actively.",
    author: "Prof. Dr. Sarah Meyer",
    role: "Computer Science, University of Zurich",
    image: "/img/testimonials/avatar1.jpg"
  },
  {
    content: "The gamification features have dramatically increased student participation. My completion rates went from 60% to over 90%.",
    author: "Dr. Thomas Schmidt",
    role: "Economics, ETH Zurich", 
    image: "/img/testimonials/avatar2.jpg"
  },
  {
    content: "Perfect for hybrid teaching. Students love the immediate feedback and I appreciate the detailed analytics.",
        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Join thousands of educators who are transforming their classrooms with KlickerUZH
            </p>
          </div>
          ...
          <dl className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <div 
                key={stat.id} 
                className="flex flex-col items-center rounded-xl bg-white px-6 py-8 shadow-sm ring-1 ring-gray-200 hover:shadow-md transition-shadow"
              >
                <div className="rounded-full bg-red-100 p-3 mb-4">
                  <FontAwesomeIcon icon={stat.icon} className="h-6 w-6 text-red-600" />
                </div>
        ...
        <div className="mx-auto mt-20 max-w-2xl lg:max-w-none">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            {testimonials.map((testimonial, index) => (
              <div 
                key={index}
                className="flex flex-col justify-between rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-200 hover:shadow-md transition-shadow"
              >
                <div>
