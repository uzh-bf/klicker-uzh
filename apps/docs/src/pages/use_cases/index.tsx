...
export default function index() {
  const {
    getCollapseProps: strengthenCollapseProps,
    getToggleProps: strengthenToggleProps,
    isExpanded: isStrengthenExpanded,
  } = useCollapse()
  ...
  return (
    <Layout>
      ...
      <div className="w-full max-w-6xl p-4 m-auto ">
        <div
          {...strengthenToggleProps()}
          className="flex flex-row items-center gap-2 "
        >
          {isStrengthenExpanded ? (
        ...
        <section {...strengthenCollapseProps()}>
      ...
      <div className="w-full max-w-6xl p-4 m-auto ">
        ...
        >
          ...
          <H2>Implement Gamification Elements</H2>
          {/* <FontAwesomeIcon icon={faPeopleGroup} /> */}
          🕹️
        </div>
        <hr className="h-1 m-0 bg-black rounded" />
      ...
      <div className="w-full max-w-6xl p-4 m-auto ">
        ...
        >
          ...
          <H2>Receive Knowledge Feedback</H2>
          {/* <FontAwesomeIcon icon={faPeopleGroup} /> */}
          📝
        </div>
        <hr className="h-1 m-0 bg-black rounded" />
      ...
      <div className="w-full max-w-6xl p-4 m-auto ">
        ...
        >
          ...
          <H2>Learning Beyond Classroom</H2>
          {/* <FontAwesomeIcon icon={faPeopleGroup} /> */}
          🌍
        </div>
        <hr className="h-1 m-0 bg-black rounded" />
