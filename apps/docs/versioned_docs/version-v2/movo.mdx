...
Please also check out the [introductory documentation](/v2/getting_started/welcome), to get started with using the KlickerUZH. If something does not work as expected after your import or later on, contact us through the embedded support channels or using our integrated chat-functionality. We will do our best to answer your questions in a timely manner.
