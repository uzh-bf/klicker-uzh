  ...
  test('Valid', async () => {
    ...
    let response_body_expected = {
      activityTypes: [
        {
          id: 'LIVE_QUIZZES',
          newTitle: 'Live Quiz Overview (5)',
          olatConfigurationKey: 'live-quizzes',
          isSubselectionRequired: false,
        },
        {
          id: 'PRACTICE_QUIZZES',
          newTitle: 'Practice Quiz Overview (5)',
          olatConfigurationKey: 'practice-quizzes',
          isSubselectionRequired: false,
        },
        {
          id: 'MICRO_LEARNINGS',
          newTitle: 'Micro Learning Overview (5)',
          olatConfigurationKey: 'micro-learnings',
          isSubselectionRequired: false,
        },
        {
    ...
    response_body_expected = {
      activityTypes: [
        {
          id: 'LIVE_QUIZZES',
          newTitle: 'Live Quiz Overview (0)',
          olatConfigurationKey: 'live-quizzes',
          isSubselectionRequired: false,
        },
        {
          id: 'PRACTICE_QUIZZES',
          newTitle: 'Practice Quiz Overview (0)',
          olatConfigurationKey: 'practice-quizzes',
          isSubselectionRequired: false,
        },
        {
          id: 'MICRO_LEARNINGS',
          newTitle: 'Micro Learning Overview (0)',
          olatConfigurationKey: 'micro-learnings',
          isSubselectionRequired: false,
        },
        {
