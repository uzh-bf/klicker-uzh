...
pnpm run script:prod src.scripts.0_initial_participant_analytics
pnpm run script:prod src.scripts.1_initial_aggregated_analytics
pnpm run script:prod src.scripts.2_initial_aggregated_course_analytics
pnpm run script:prod src.scripts.3_initial_instance_activity_performance
pnpm run script:prod src.scripts.4_initial_participant_performance
