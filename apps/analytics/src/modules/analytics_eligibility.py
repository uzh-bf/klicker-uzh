...
def load_course_question_responses(
    ...
    """Load only prospective QuestionResponse rows of the eligible cohort."""
...
def validate_analytics_eligibility(
    ...
    The publication boundary carries the course identifiers, but course-level
    activation does not exist on this branch yet, so the revalidation covers
    the eligibility generation and the participant cohort only. The course loop
    lands together with the course activation layer.
    """
