...
def test_compute_outcomes_scopes_by_course_id():
    ...
    buffer.record(
        "ParticipantChatAnalytics",
        [
            {"type": "COURSE", "courseId": "c1", "participantId": "p1", "userMessages": 5},
            {"type": "COURSE", "courseId": "c2", "participantId": "p9", "userMessages": 5},
        ],
    )
    buffer.record(
        "ParticipantPerformance",
        [
            {"courseId": "c1", "participantId": "p1", "firstErrorRate": 0.1, "lastErrorRate": 0.05},
            {"courseId": "c2", "participantId": "p9", "firstErrorRate": 0.1, "lastErrorRate": 0.05},
        ],
    )
