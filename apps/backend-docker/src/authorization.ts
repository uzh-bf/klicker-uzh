...
export const AuthSchema = {
  Mutation: {
    ...
    manipulateSCQuestion: { __authz: { rules: ['IsUserOrAdmin'] } },
    manipulateMCQuestion: { __authz: { rules: ['IsUserOrAdmin'] } },
    manipulateKPRIMQuestion: { __authz: { rules: ['IsUserOrAdmin'] } },
    manipulateNUMERICALQuestion: { __authz: { rules: ['IsUserOrAdmin'] } },
    manipulateFREETEXTQuestion: { __authz: { rules: ['IsUserOrAdmin'] } },
