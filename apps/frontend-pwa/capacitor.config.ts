...
const klickerWebviewHosts = serverHost.endsWith('.uzh.ch')
  ? ['pwa.klicker.uzh.ch', 'assessment.klicker.uzh.ch']
  : ['pwa.klicker.com', 'assessment.klicker.com']
...
const config: CapacitorConfig = {
  ...
  server: {
    ...
    allowNavigation: klickerWebviewHosts,
  },
}
