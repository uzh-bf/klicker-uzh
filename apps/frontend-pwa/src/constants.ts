// TODO: remove commented stuff if it is not needed anymore for pwa
...
export const QUESTION_GROUPS = {
  ...
  WITH_PERCENTAGES: [QUESTION_TYPES.SC, QUESTION_TYPES.MC, QUESTION_TYPES.FREE_TEXT],
  WITH_POSSIBILITIES: [QUESTION_TYPES.SC, QUESTION_TYPES.MC, QUESTION_TYPES.NUMERICAL],
