    ...
    return (
      <Html>
        <Head>
          ...
          <meta name="application-name" content="Klicker UZH PWA" />
          <meta name="apple-mobile-web-app-capable" content="yes" />
          <meta name="apple-mobile-web-app-status-bar-style" content="default" />
          <meta name="apple-mobile-web-app-title" content="Klicker UZH PWA" />
          <meta name="description" content="Open Source Audience Interaction" />
