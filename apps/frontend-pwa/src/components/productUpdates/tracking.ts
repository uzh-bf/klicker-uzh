...
// The adoption funnel is read as one Matomo category across both applications,
...
// lives at module scope so that the header and the mobile menu bar agree, and
// it resets with the next full page load.
