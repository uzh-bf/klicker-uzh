...
Response check: is there only one practice question unless this is a practice checkpoint, is its provenance honest, is the answer still hidden when the student should attempt it first, is feedback criterion-linked and actionable without invented weaknesses, and does the response keep the practice moving without an unnecessary permission check or unsupported mastery claim?`,
  },
}
