...
function CaseStudyCriteriaFields() {
  ...
  return (
    <div>
      ...
      <div className="mb-2">
        {t('manage.elementForms.caseStudyCriteriaDescription')}
      </div>
            ...
            <>
              {criteriaField.value?.map((criterion, index) => (
                ...
                >
                  ...
                  <div className="mb-1 flex flex-row items-center justify-between">
                    <div className="font-medium">
                      ...
                      {criterion.mode === 'range'
                        ? t('manage.elementForms.caseStudyRangeCriterion')
                        : t('manage.elementForms.caseStudyStepCriterion')}
                    </div>
                    <Button
                      destructive
                      onClick={() => {
                  ...
                  <FormikTextField
                    ...
                    tooltip={t(
                      'manage.elementForms.caseStudyCriteriaNameTooltip'
                    )}
                    className={{
                      root: 'mb-2 w-full',
                      tooltip: 'max-w-[30rem]',
                  ...
                  {(criterion.mode === 'range' ||
                    ...
                    <div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4">
                      <FormikNumberField
                        ...
                        tooltip={t(
                          'manage.elementForms.caseStudyCriteriaMinTooltip'
                        )}
                        className={{
                          root: 'w-full',
                          tooltip: 'max-w-[30rem]',
                      ...
                      <FormikNumberField
                        ...
                        tooltip={t(
                          'manage.elementForms.caseStudyCriteriaMaxTooltip'
                        )}
                        className={{
                          root: 'w-full',
                          tooltip: 'max-w-[30rem]',
                      ...
                      <FormikNumberField
                        ...
                        tooltip={t(
                          'manage.elementForms.caseStudyCriteriaStepTooltip'
                        )}
                        className={{
                          root: 'w-full',
                          tooltip: 'max-w-[30rem]',
                      ...
                      <FormikTextField
                        ...
                        tooltip={t(
                          'manage.elementForms.caseStudyCriteriaUnitTooltip'
                        )}
                        className={{
                          root: 'w-full',
                          tooltip: 'max-w-[30rem]',
                  ...
                  {criterion.mode === 'steps' && (
                    <div className="grid grid-cols-1 gap-2 md:grid-cols-4">
                      <FormikTextField
                        ...
                        tooltip={t(
                          'manage.elementForms.caseStudyCriteriaMinLabelTooltip'
                        )}
                        maxLength={100}
                        className={{
                          root: 'w-full',
                      ...
                      <FormikTextField
                        ...
                        placeholder={t('shared.generic.textInput')}
                        tooltip={t(
                          'manage.elementForms.caseStudyCriteriaMidLabelTooltip'
                        )}
                        maxLength={100}
                        className={{
                          root: 'w-full',
                      ...
                      <FormikTextField
                        ...
                        placeholder={t('shared.generic.textInput')}
                        tooltip={t(
                          'manage.elementForms.caseStudyCriteriaMaxLabelTooltip'
                        )}
                        maxLength={100}
                        className={{
                          root: 'w-full',
                      ...
                      <NumberField
                        ...
                        tooltip={t(
                          'manage.elementForms.caseStudyCriteriaStepsTooltip'
                        )}
                        className={{
                          field: 'w-full',
                          tooltip: 'max-w-[30rem]',
              ...
              <div className="mt-1 flex flex-col gap-2 sm:flex-row">
                ...
                >
                  ...
                  <Button.Label>
                    {t('manage.elementForms.addRangeCriterion')}
                  </Button.Label>
                </Button>
                <Button
                  onClick={() =>
                ...
                >
                  <Button.Icon icon={faPlus} />
                  <Button.Label>
                    {t('manage.elementForms.addStepsCriterion')}
                  </Button.Label>
                </Button>
              </div>
            </>
