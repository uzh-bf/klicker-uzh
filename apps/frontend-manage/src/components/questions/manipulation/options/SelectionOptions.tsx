  ...
  if (collections.length === 0) {
    return (
      <UserNotification type="warning" className={{ root: 'text-base' }}>
        {t.rich('manage.elementForms.SEAnswerCollectionRequired', {
          link: (text) => (
            <Link
              href="/resources"
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-1 lg:flex-row lg:items-start lg:gap-4">
        <div className="flex flex-row items-end gap-1">
          <FormikSelectField
            ...
            labelType="small"
            tooltip={t('manage.elementForms.SELECTIONOptionsTooltip')}
        ...
        <FormikNumberField
          ...
          label={t('manage.elementForms.numberOfInputs')}
          labelType="small"
      ...
      {values.options.hasSampleSolution ? (
        <div>
          <FormLabel
            required
            label={t('manage.elementForms.correctAnswerOptions')}
            tooltip={t('manage.elementForms.correctAnswerOptionsTooltip')}
            labelType="small"
          />
          <div data-cy="choose-correct-answer-options">
            <Select
              ...
              placeholder={t('manage.elementForms.selectAnswerOptions')}
              noOptionsMessage={() =>
