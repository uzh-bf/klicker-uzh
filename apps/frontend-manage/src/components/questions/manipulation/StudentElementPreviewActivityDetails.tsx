...
function StudentElementPreviewActivityDetails({
  ...
  const explanationOrFeedbacksDefined =
    'explanation' in instance.elementData &&
    instance.elementType !== ElementType.Flashcard &&
    ((instance.elementData.explanation &&
      !instance.elementData.explanation.match(/^(<br>(\n)*)$/g) &&
      instance.elementData.explanation !== '') ||
      ('options' in instance.elementData &&
        'hasAnswerFeedbacks' in instance.elementData.options &&
        instance.elementData.options.hasAnswerFeedbacks))

  const values = instance.elementData
