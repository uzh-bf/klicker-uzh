            ...
            <div className="flex flex-row">
              <div className="w-full md:w-1/2">
                <div className="w-full md:pr-14">
                  {t('manage.activityWizard.pollIntroductionName')}
                </div>
                <FormikTextField
                  required
                  autoComplete="off"
                  ...
                  tooltip={t('manage.activityWizard.pollName')}
                  className={{
                    root: 'mb-2 md:w-96',
                    tooltip: 'z-20',
                  }}
                  data-cy="insert-poll-name"
                />
              </div>
                  ...
                  elements={[
                    {
                      ...
                      richText: t.rich('manage.activityWizard.pollUseCase', {
                        link: (text) => (
                          <a
...
export default PollInformationStep
