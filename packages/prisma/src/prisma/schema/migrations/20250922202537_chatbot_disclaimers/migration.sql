...
-- AddForeignKey
ALTER TABLE "public"."ChatbotDisclaimer" ADD CONSTRAINT "ChatbotDisclaimer_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
