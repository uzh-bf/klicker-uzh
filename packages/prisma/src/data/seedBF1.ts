...
async function seed(prisma: Prisma.PrismaClient) {
  ...
  // TODO: seed results for first group challenge - format:
  // {"points": 900, "message": "[Feedback als PDF](https://sos-ch-dk-2.exo.io/klicker-prod/pdf/Feedback%20Gruppen%20Challenge_UZH%20Gang_ow4Kdv5X9XD6dLb3gCsf.pdf)", "maxPoints": 1000}
  const updatedGC1 = await prisma.groupActivityInstance.update({
    where: {
      id: '// TODO',
    },
    include: {
