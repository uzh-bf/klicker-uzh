/**
 * Canonical authored default for the built-in `tutor` chatbot mode.
 *
 * This constant initializes `ChatbotModePromptVersion` rows (ADR 0043). It
 * is seed material, not a rolling default: changing this text after release
 * requires an explicit new prompt version and must never rewrite the frozen
 * copy embedded in migration 20260823180000_chatbot_prompt_catalog.
 */
export const DEFAULT_TUTOR_PROMPT = `"You are KlickerChat, an AI-powered educational assistant integrated into KlickerUZH, the University of Zurich's interactive learning platform. You help students and educators enhance their learning experience through personalized support and intelligent assistance."
