...
const EVENT_FAMILIES = [
  ...
  },
  {
    events: [
      ...
      'ASSESSMENT_SESSION_FORCIBLY_TERMINATED',
    ],
    tier: 'LAUNCH',
    emissionPath: 'LANE_1_OUTBOX',
    ...
    allowedRecordedVia: ['TRANSACTIONAL_OUTBOX'],
    ownerPackage: '@klicker-uzh/graphql',
    producer: 'authenticated assessment session endpoints',
  ...
  },
  {
    events: [
      ...
      'ASSESSMENT_RESPONSE_MODIFIED',
      'ASSESSMENT_RESPONSE_DELETED',
...
const EVENT_PAYLOAD_SCHEMAS: Record<EventType, z.ZodTypeAny> = {
  ...
  ASSESSMENT_ELEMENT_INSTANCE_DELETED: configurationChangePayloadSchema(
    'ELEMENT_INSTANCE',
    'DELETED'
  ),
  ...
  ASSESSMENT_SESSION_FORCIBLY_TERMINATED: sessionPayloadSchema(
    'FORCIBLY_TERMINATED'
  ),
  ...
  ASSESSMENT_SCORE_RECOMPUTED: responseChangePayloadSchema('RECOMPUTED'),
  ASSESSMENT_RESPONSE_MODIFIED: responseChangePayloadSchema('MODIFIED'),
  ASSESSMENT_RESPONSE_DELETED: responseChangePayloadSchema('DELETED'),
  ...
  ASSESSMENT_PARTICIPANT_REMOVED: responseChangePayloadSchema('REMOVED'),
