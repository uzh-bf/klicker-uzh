...
<li>Änderungen des Elementstatus sind durch alle Nutzer möglich.</li>
    ...
    courseList: {
      ...
      deleteDraftLiveQuizzesOption:
        '{number, plural, one {Das verknüpfte Live-Quiz im Entwurfsstatus ebenfalls unwiderruflich löschen.} other {Die # verknüpften Live-Quizzes im Entwurfsstatus ebenfalls unwiderruflich löschen.}}',
      deleteDraftLiveQuizzes:
        '{number, plural, one {Das verknüpfte Live-Quiz im Entwurfsstatus wird unwiderruflich gelöscht.} other {Die # verknüpften Live-Quizzes im Entwurfsstatus werden unwiderruflich gelöscht.}} Alle übrigen Live-Quizzes werden vom Kurs getrennt und bleiben über die Aktivitätenliste zugänglich.',
