...
`,
    ...
    practiceQuiz: {
      ...
      semanticPending: 'Your answer is being evaluated.',
      semanticUnavailable:
        'Semantic feedback is currently unavailable. This does not mean that your answer is incorrect.',
      semanticReady: 'Your next answer is ready to be submitted.',
      semanticCorrect: 'Correct',
      semanticPartiallyCorrect: 'Partially correct',
      semanticIncorrect: 'Not yet correct',
      semanticAttemptsUsed: 'Answer attempts: {used} of {limit}',
      semanticAttemptsRemaining:
        '{remaining, plural, =1 {1 attempt remaining} other {# attempts remaining}}',
      semanticRewardDelta: 'Awarded: {points} points, {xp} XP',
      semanticActionFailed:
        'The action could not be completed. Please try again.',
      semanticTryAgain: 'Try again',
      semanticSubmitAnswer: 'Submit answer',
      semanticSubmitImprovedAnswer: 'Submit improved answer',
      semanticRetryEvaluation: 'Retry evaluation',
      semanticShowSolution: 'Show solution',
      semanticViewExplanation: 'View explanation',
      semanticHideExplanation: 'Hide explanation',
      semanticPracticeAgain: 'Practice again',
      semanticAttemptHistory: 'Previous answers',
      semanticHistoryPending: 'Evaluation pending',
