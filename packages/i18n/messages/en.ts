...
`,
    ...
    profile: {
      ...
      learningAnalyticsConsentDescription:
        'Yes allows KlickerUZH to use all eligible stored activity data for your account for individual learning analytics after a successful course recomputation whose marker is strictly newer than your current choice. No means that no individual learning-analytics data is used; existing individual learning-analytics data is deleted during the next successful overnight processing cycle. Aggregate results are updated when they are next recomputed. If you turn this back on, all eligible stored activity data can be included again.',
