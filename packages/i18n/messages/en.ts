...
`,
  ...
  kb: {
    ...
    speedModeFast: 'Fast',
    knowledgeGraphAssigned: 'Knowledge graph: {chatbotName}',
  },
  manage: {
    general: {
      qrCode: 'QR Code',
...
<li>Element status changes can be performed by all users.</li>
    ...
    resources: {
      ...
      knowledgeGraphDescription:
        'Select the course materials for this chatbot, then build its interactive knowledge graph.',
      knowledgeGraphLoading: 'Loading knowledge graph configuration…',
      knowledgeGraphLoadError:
        'The knowledge graph configuration could not be loaded.',
      knowledgeGraphRetry: 'Retry',
      knowledgeGraphResourcesTitle: 'Knowledge base resources',
      knowledgeGraphSelectedCount:
        '{count, plural, =0 {No resources selected} one {# resource selected} other {# resources selected}}',
      knowledgeGraphUnsavedChanges: 'Unsaved selection',
      knowledgeGraphNoResources:
        'Add resources to a knowledge base before configuring this graph.',
      knowledgeGraphUnknownAssignedChatbot: 'another chatbot',
      knowledgeGraphResourceFile: 'File',
      knowledgeGraphResourceUrl: 'Public URL',
      knowledgeGraphAssignedElsewhere:
        'Already assigned to “{chatbotName}”. A resource can belong to only one chatbot graph.',
      knowledgeGraphSaveSelection: 'Save selection',
      knowledgeGraphSelectionSaved: 'Resource selection saved.',
      knowledgeGraphSelectionSaveError:
        'The resource selection could not be saved. Please try again.',
      ...
      knowledgeGraphRebuild: 'Rebuild',
      knowledgeGraphBuildError:
        'The knowledge graph build could not be started. Please try again.',
      knowledgeGraphStatus: 'Status',
      knowledgeGraphStatusEmpty: 'No resources',
      knowledgeGraphStatusDirty: 'Build required',
      knowledgeGraphStatusQueued: 'Queued',
      knowledgeGraphStatusProcessing: 'Processing',
      knowledgeGraphStatusReady: 'Ready',
      knowledgeGraphStatusFailed: 'Failed',
      knowledgeGraphExternalRun: 'External workflow run: {runId}',
      knowledgeGraphLastBuilt: 'Last successful build: {date} ({speed})',
      knowledgeGraphUnknownSpeed: 'unknown mode',
      knowledgeGraphPreviewTitle: 'Knowledge graph preview',
      knowledgeGraphPreviewUnavailable:
        'The preview becomes available after the current resource selection has been built successfully.',
      knowledgeGraphViewer: {
        ...
        loadedConcepts: 'Loaded concepts ({count})',
        noConceptsLoaded: 'No concepts loaded.',
        loadedRelationships: 'Loaded relationships ({count})',
        ...
        connectionsUnavailable:
          'Connections are temporarily unavailable. Try again.',
        graphUnavailable: 'The knowledge graph is temporarily unavailable.',
        searchResultsLoadedAnnouncement:
          '{count, plural, =0 {No search results loaded.} one {# search result loaded.} other {# search results loaded.}}',
        conceptsLoadedAnnouncement:
          '{count, plural, =0 {No concepts loaded.} one {# concept loaded.} other {# concepts loaded.}}',
        selectedConceptAnnouncement: 'Selected {label}.',
