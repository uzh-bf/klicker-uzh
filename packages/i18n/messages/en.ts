  ...
  shared: {
    ...
    leaderboard: {
      ...
      liveQuizGamifiedCourseNoParticipation:
        'This live quiz is part of a gamified course. Since you have not joined this course, you will only collect points within this quiz. Your points will appear on the quiz leaderboard. If you do not want this, please log out and rejoin the quiz via the link.',
      liveQuizCourseParticipationInactive:
        'This live quiz is part of a gamified course, but you are currently not participating in the gamification. To join the leaderboard and collect points in this quiz, join the leaderboard on the course overview and rejoin the quiz.',
      rank: 'Rank',
      username: 'Username',
      email: 'Email',
    },
