...
Input fingerprint: `c5f294252e70788361526d31e56454c930d2b3f88fe12980cebec7e24326aae2`. Evidence: `RELEASE`; estimator: `IRT_V2_EAP_GRID_1`; policy: 1.
...
| --------: | ---------: | -------------: | -----------------------: | -------------: | -------------: | --------------------- | -------------------------------------------: | ------- |
|      0.80 |     100.0% |         100.0% |                    33.3% |          0.043 |          1.674 | 27.0% - 29.3%         |                        13.3% / 0.0% / 100.0% | BLOCKED |
|      0.90 |      36.0% |          37.6% |                    85.9% |          0.025 |          0.732 | 60.0% - 62.4%         |                      87.8% / 100.0% / 100.0% | BLOCKED |
|      0.95 |      19.3% |          19.5% |                    97.0% |          0.017 |          0.598 | 62.8% - 65.3%         |                      98.0% / 100.0% / 100.0% | BLOCKED |
...
| --------: | ------------------------------------------------------------------- | -----: | -------- |
|      0.80 | rmseUpper95                                                         |  1.674 | <= 0.5   |
|      0.80 | credibleCoverageLower95                                             |  0.270 | >= 0.85  |
|      0.80 | classifiedBandAccuracyLower95                                       |  0.322 | >= 0.9   |
|      0.80 | sampledMaximumPairwiseFormOverlapRate                               |  1.000 | <= 0.9   |
|      0.80 | stratum:band:Foundation:credibleCoverageLower95                     |  0.000 | >= 0.85  |
|      0.80 | stratum:band:Foundation:absoluteBiasUpper95                         |  1.939 | <= 0.1   |
|      0.80 | stratum:band:Foundation:rmseUpper95                                 |  1.991 | <= 0.5   |
|      0.80 | stratum:band:Foundation:classifiedBandAccuracyLower95               |  0.000 | >= 0.9   |
|      0.80 | stratum:band:Independent:credibleCoverageLower95                    |  0.826 | >= 0.85  |
|      0.80 | stratum:band:Independent:rmseUpper95                                |  0.735 | <= 0.5   |
|      0.80 | stratum:band:Advanced:credibleCoverageLower95                       |  0.000 | >= 0.85  |
|      0.80 | stratum:band:Advanced:absoluteBiasUpper95                           |  1.933 | <= 0.1   |
|      0.80 | stratum:band:Advanced:rmseUpper95                                   |  1.981 | <= 0.5   |
|      0.80 | stratum:band:Advanced:classifiedBandAccuracyLower95                 |  0.000 | >= 0.9   |
|      0.80 | stratum:root:1:credibleCoverageLower95                              |  0.412 | >= 0.85  |
|      0.80 | stratum:root:1:rmseUpper95                                          |  1.689 | <= 0.5   |
|      0.80 | stratum:root:1:classifiedBandAccuracyLower95                        |  0.322 | >= 0.9   |
|      0.80 | stratum:root:6:credibleCoverageLower95                              |  0.410 | >= 0.85  |
|      0.80 | stratum:root:6:rmseUpper95                                          |  1.687 | <= 0.5   |
...
|      0.80 | stratum:course-cohort:COHORT_A:credibleCoverageLower95              |  0.264 | >= 0.85  |
|      0.80 | stratum:course-cohort:COHORT_A:rmseUpper95                          |  1.688 | <= 0.5   |
|      0.80 | stratum:course-cohort:COHORT_A:classifiedBandAccuracyLower95        |  0.313 | >= 0.9   |
|      0.80 | stratum:course-cohort:COHORT_B:credibleCoverageLower95              |  0.262 | >= 0.85  |
|      0.80 | stratum:course-cohort:COHORT_B:rmseUpper95                          |  1.681 | <= 0.5   |
|      0.80 | stratum:course-cohort:COHORT_B:classifiedBandAccuracyLower95        |  0.313 | >= 0.9   |
|      0.80 | stratum:course-cohort:COHORT_C:credibleCoverageLower95              |  0.260 | >= 0.85  |
|      0.80 | stratum:course-cohort:COHORT_C:rmseUpper95                          |  1.684 | <= 0.5   |
...
|      0.80 | stratum:theta-cell:Foundation:0:-2.9:absoluteBiasUpper95            |  2.507 | <= 0.1   |
|      0.80 | stratum:theta-cell:Foundation:0:-2.9:rmseUpper95                    |  2.512 | <= 0.5   |
...
|      0.80 | stratum:theta-cell:Foundation:1:-2.6:absoluteBiasUpper95            |  2.213 | <= 0.1   |
|      0.80 | stratum:theta-cell:Foundation:1:-2.6:rmseUpper95                    |  2.220 | <= 0.5   |
...
|      0.80 | stratum:theta-cell:Foundation:2:-2.3:absoluteBiasUpper95            |  1.938 | <= 0.1   |
|      0.80 | stratum:theta-cell:Foundation:2:-2.3:rmseUpper95                    |  1.949 | <= 0.5   |
...
|      0.80 | stratum:theta-cell:Foundation:3:-2:absoluteBiasUpper95              |  1.662 | <= 0.1   |
|      0.80 | stratum:theta-cell:Foundation:3:-2:rmseUpper95                      |  1.676 | <= 0.5   |
|      0.80 | stratum:theta-cell:Foundation:3:-2:classifiedBandAccuracyLower95    |  0.000 | >= 0.9   |
|      0.80 | stratum:theta-cell:Foundation:4:-1.7:credibleCoverageLower95        |  0.000 | >= 0.85  |
|      0.80 | stratum:theta-cell:Foundation:4:-1.7:absoluteBiasUpper95            |  1.379 | <= 0.1   |
|      0.80 | stratum:theta-cell:Foundation:4:-1.7:rmseUpper95                    |  1.402 | <= 0.5   |
|      0.80 | stratum:theta-cell:Foundation:4:-1.7:classifiedBandAccuracyLower95  |  0.000 | >= 0.9   |
|      0.80 | stratum:theta-cell:Independent:0:-1.2:credibleCoverageLower95       |  0.612 | >= 0.85  |
|      0.80 | stratum:theta-cell:Independent:0:-1.2:absoluteBiasUpper95           |  0.952 | <= 0.1   |
|      0.80 | stratum:theta-cell:Independent:0:-1.2:rmseUpper95                   |  0.989 | <= 0.5   |
|      0.80 | stratum:theta-cell:Independent:1:-0.6:credibleCoverageUpper95       |  0.973 | <= 0.95  |
|      0.80 | stratum:theta-cell:Independent:1:-0.6:absoluteBiasUpper95           |  0.482 | <= 0.1   |
|      0.80 | stratum:theta-cell:Independent:1:-0.6:rmseUpper95                   |  0.582 | <= 0.5   |
|      0.80 | stratum:theta-cell:Independent:2:0:credibleCoverageUpper95          |  1.000 | <= 0.95  |
|      0.80 | stratum:theta-cell:Independent:3:0.6:credibleCoverageUpper95        |  0.965 | <= 0.95  |
|      0.80 | stratum:theta-cell:Independent:3:0.6:absoluteBiasUpper95            |  0.485 | <= 0.1   |
|      0.80 | stratum:theta-cell:Independent:3:0.6:rmseUpper95                    |  0.573 | <= 0.5   |
|      0.80 | stratum:theta-cell:Independent:4:1.2:credibleCoverageLower95        |  0.602 | >= 0.85  |
|      0.80 | stratum:theta-cell:Independent:4:1.2:absoluteBiasUpper95            |  0.955 | <= 0.1   |
|      0.80 | stratum:theta-cell:Independent:4:1.2:rmseUpper95                    |  0.990 | <= 0.5   |
|      0.80 | stratum:theta-cell:Advanced:0:1.7:credibleCoverageLower95           |  0.000 | >= 0.85  |
|      0.80 | stratum:theta-cell:Advanced:0:1.7:absoluteBiasUpper95               |  1.369 | <= 0.1   |
|      0.80 | stratum:theta-cell:Advanced:0:1.7:rmseUpper95                       |  1.386 | <= 0.5   |
...
|      0.80 | stratum:theta-cell:Advanced:1:2:absoluteBiasUpper95                 |  1.642 | <= 0.1   |
|      0.80 | stratum:theta-cell:Advanced:1:2:rmseUpper95                         |  1.651 | <= 0.5   |
...
|      0.80 | stratum:theta-cell:Advanced:2:2.3:absoluteBiasUpper95               |  1.925 | <= 0.1   |
|      0.80 | stratum:theta-cell:Advanced:2:2.3:rmseUpper95                       |  1.930 | <= 0.5   |
...
|      0.80 | stratum:theta-cell:Advanced:3:2.6:absoluteBiasUpper95               |  2.212 | <= 0.1   |
|      0.80 | stratum:theta-cell:Advanced:3:2.6:rmseUpper95                       |  2.218 | <= 0.5   |
...
|      0.80 | stratum:theta-cell:Advanced:4:2.9:absoluteBiasUpper95               |  2.500 | <= 0.1   |
|      0.80 | stratum:theta-cell:Advanced:4:2.9:rmseUpper95                       |  2.504 | <= 0.5   |
|      0.80 | stratum:theta-cell:Advanced:4:2.9:classifiedBandAccuracyLower95     |  0.000 | >= 0.9   |
|      0.80 | stratum:cut-distance:NEAR_CUT:credibleCoverageLower95               |  0.225 | >= 0.85  |
|      0.80 | stratum:cut-distance:NEAR_CUT:confidentMisclassificationRateUpper95 |  0.695 | <= 0.01  |
|      0.80 | stratum:cut-distance:INTERIOR:credibleCoverageLower95               |  0.270 | >= 0.85  |
|      0.80 | stratum:cut-distance:INTERIOR:rmseUpper95                           |  1.675 | <= 0.5   |
|      0.80 | stratum:cut-distance:INTERIOR:classifiedBandAccuracyLower95         |  0.322 | >= 0.9   |
|      0.90 | rmseUpper95                                                         |  0.732 | <= 0.5   |
|      0.90 | credibleCoverageLower95                                             |  0.600 | >= 0.85  |
...
|      0.90 | stratum:band:Foundation:credibleCoverageLower95                     |  0.465 | >= 0.85  |
|      0.90 | stratum:band:Foundation:absoluteBiasUpper95                         |  0.680 | <= 0.1   |
|      0.90 | stratum:band:Foundation:rmseUpper95                                 |  0.846 | <= 0.5   |
...
|      0.90 | stratum:band:Advanced:credibleCoverageLower95                       |  0.486 | >= 0.85  |
|      0.90 | stratum:band:Advanced:absoluteBiasUpper95                           |  0.651 | <= 0.1   |
|      0.90 | stratum:band:Advanced:rmseUpper95                                   |  0.789 | <= 0.5   |
...
|      0.90 | stratum:root:6:credibleCoverageLower95                              |  0.753 | >= 0.85  |
|      0.90 | stratum:root:6:rmseUpper95                                          |  0.813 | <= 0.5   |
...
|      0.90 | stratum:course-cohort:COHORT_A:credibleCoverageLower95              |  0.609 | >= 0.85  |
...
|      0.90 | stratum:course-cohort:COHORT_B:rmseUpper95                          |  0.752 | <= 0.5   |
|      0.90 | stratum:course-cohort:COHORT_B:classifiedBandAccuracyLower95        |  0.807 | >= 0.9   |
|      0.90 | stratum:course-cohort:COHORT_C:credibleCoverageLower95              |  0.578 | >= 0.85  |
|      0.90 | stratum:course-cohort:COHORT_C:rmseUpper95                          |  0.747 | <= 0.5   |
|      0.90 | stratum:course-cohort:COHORT_C:classifiedBandAccuracyLower95        |  0.842 | >= 0.9   |
|      0.90 | stratum:theta-cell:Foundation:0:-2.9:credibleCoverageLower95        |  0.293 | >= 0.85  |
|      0.90 | stratum:theta-cell:Foundation:0:-2.9:absoluteBiasUpper95            |  0.799 | <= 0.1   |
|      0.90 | stratum:theta-cell:Foundation:0:-2.9:rmseUpper95                    |  0.937 | <= 0.5   |
...
|      0.90 | stratum:theta-cell:Foundation:1:-2.6:rmseUpper95                    |  0.952 | <= 0.5   |
|      0.90 | stratum:theta-cell:Foundation:1:-2.6:classifiedBandAccuracyLower95  |  0.630 | >= 0.9   |
|      0.90 | stratum:theta-cell:Foundation:2:-2.3:credibleCoverageLower95        |  0.436 | >= 0.85  |
|      0.90 | stratum:theta-cell:Foundation:2:-2.3:absoluteBiasUpper95            |  0.691 | <= 0.1   |
|      0.90 | stratum:theta-cell:Foundation:2:-2.3:rmseUpper95                    |  0.846 | <= 0.5   |
|      0.90 | stratum:theta-cell:Foundation:2:-2.3:classifiedBandAccuracyLower95  |  0.284 | >= 0.9   |
|      0.90 | stratum:theta-cell:Foundation:3:-2:credibleCoverageLower95          |  0.471 | >= 0.85  |
|      0.90 | stratum:theta-cell:Foundation:3:-2:absoluteBiasUpper95              |  0.701 | <= 0.1   |
|      0.90 | stratum:theta-cell:Foundation:3:-2:rmseUpper95                      |  0.867 | <= 0.5   |
|      0.90 | stratum:theta-cell:Foundation:3:-2:classifiedBandAccuracyLower95    |  0.011 | >= 0.9   |
|      0.90 | stratum:theta-cell:Foundation:4:-1.7:credibleCoverageLower95        |  0.594 | >= 0.85  |
|      0.90 | stratum:theta-cell:Foundation:4:-1.7:absoluteBiasUpper95            |  0.566 | <= 0.1   |
|      0.90 | stratum:theta-cell:Foundation:4:-1.7:rmseUpper95                    |  0.752 | <= 0.5   |
...
|      0.90 | stratum:theta-cell:Independent:0:-1.2:absoluteBiasUpper95           |  0.549 | <= 0.1   |
|      0.90 | stratum:theta-cell:Independent:0:-1.2:rmseUpper95                   |  0.729 | <= 0.5   |
...
|      0.90 | stratum:theta-cell:Independent:3:0.6:absoluteBiasUpper95            |  0.355 | <= 0.1   |
|      0.90 | stratum:theta-cell:Independent:4:1.2:credibleCoverageLower95        |  0.669 | >= 0.85  |
|      0.90 | stratum:theta-cell:Independent:4:1.2:absoluteBiasUpper95            |  0.501 | <= 0.1   |
|      0.90 | stratum:theta-cell:Independent:4:1.2:rmseUpper95                    |  0.691 | <= 0.5   |
|      0.90 | stratum:theta-cell:Advanced:0:1.7:credibleCoverageLower95           |  0.587 | >= 0.85  |
|      0.90 | stratum:theta-cell:Advanced:0:1.7:absoluteBiasUpper95               |  0.602 | <= 0.1   |
|      0.90 | stratum:theta-cell:Advanced:0:1.7:rmseUpper95                       |  0.787 | <= 0.5   |
...
|      0.90 | stratum:theta-cell:Advanced:1:2:absoluteBiasUpper95                 |  0.594 | <= 0.1   |
|      0.90 | stratum:theta-cell:Advanced:1:2:rmseUpper95                         |  0.763 | <= 0.5   |
...
|      0.90 | stratum:theta-cell:Advanced:2:2.3:absoluteBiasUpper95               |  0.675 | <= 0.1   |
|      0.90 | stratum:theta-cell:Advanced:2:2.3:rmseUpper95                       |  0.815 | <= 0.5   |
|      0.90 | stratum:theta-cell:Advanced:2:2.3:classifiedBandAccuracyLower95     |  0.309 | >= 0.9   |
|      0.90 | stratum:theta-cell:Advanced:3:2.6:credibleCoverageLower95           |  0.370 | >= 0.85  |
|      0.90 | stratum:theta-cell:Advanced:3:2.6:absoluteBiasUpper95               |  0.712 | <= 0.1   |
...
|      0.90 | stratum:theta-cell:Advanced:4:2.9:absoluteBiasUpper95               |  0.772 | <= 0.1   |
|      0.90 | stratum:theta-cell:Advanced:4:2.9:rmseUpper95                       |  0.869 | <= 0.5   |
|      0.90 | stratum:cut-distance:NEAR_CUT:credibleCoverageLower95               |  0.587 | >= 0.85  |
|      0.90 | stratum:cut-distance:NEAR_CUT:confidentMisclassificationRateUpper95 |  0.235 | <= 0.01  |
|      0.90 | stratum:cut-distance:INTERIOR:credibleCoverageLower95               |  0.600 | >= 0.85  |
|      0.90 | stratum:cut-distance:INTERIOR:rmseUpper95                           |  0.731 | <= 0.5   |
|      0.90 | stratum:cut-distance:INTERIOR:classifiedBandAccuracyLower95         |  0.844 | >= 0.9   |
|      0.95 | rmseUpper95                                                         |  0.598 | <= 0.5   |
|      0.95 | credibleCoverageLower95                                             |  0.628 | >= 0.85  |
|      0.95 | classificationRateLower95                                           |  0.204 | >= 0.8   |
|      0.95 | requiredRootClassificationRateLower95                               |  0.186 | >= 0.75  |
...
|      0.95 | stratum:band:Foundation:credibleCoverageLower95                     |  0.502 | >= 0.85  |
|      0.95 | stratum:band:Foundation:absoluteBiasUpper95                         |  0.574 | <= 0.1   |
|      0.95 | stratum:band:Foundation:rmseUpper95                                 |  0.667 | <= 0.5   |
|      0.95 | stratum:band:Foundation:classifiedBandAccuracyLower95               |  0.773 | >= 0.9   |
|      0.95 | stratum:band:Advanced:credibleCoverageLower95                       |  0.503 | >= 0.85  |
|      0.95 | stratum:band:Advanced:absoluteBiasUpper95                           |  0.584 | <= 0.1   |
|      0.95 | stratum:band:Advanced:rmseUpper95                                   |  0.676 | <= 0.5   |
|      0.95 | stratum:band:Advanced:classifiedBandAccuracyLower95                 |  0.778 | >= 0.9   |
|      0.95 | stratum:root:1:credibleCoverageLower95                              |  0.770 | >= 0.85  |
|      0.95 | stratum:root:1:rmseUpper95                                          |  0.660 | <= 0.5   |
|      0.95 | stratum:root:6:credibleCoverageLower95                              |  0.773 | >= 0.85  |
|      0.95 | stratum:root:6:rmseUpper95                                          |  0.674 | <= 0.5   |
...
|      0.95 | stratum:course-cohort:COHORT_A:credibleCoverageLower95              |  0.631 | >= 0.85  |
...
|      0.95 | stratum:course-cohort:COHORT_B:rmseUpper95                          |  0.597 | <= 0.5   |
|      0.95 | stratum:course-cohort:COHORT_C:credibleCoverageLower95              |  0.614 | >= 0.85  |
|      0.95 | stratum:course-cohort:COHORT_C:rmseUpper95                          |  0.608 | <= 0.5   |
...
|      0.95 | stratum:theta-cell:Foundation:0:-2.9:rmseUpper95                    |  0.767 | <= 0.5   |
|      0.95 | stratum:theta-cell:Foundation:1:-2.6:credibleCoverageLower95        |  0.434 | >= 0.85  |
|      0.95 | stratum:theta-cell:Foundation:1:-2.6:absoluteBiasUpper95            |  0.630 | <= 0.1   |
|      0.95 | stratum:theta-cell:Foundation:1:-2.6:rmseUpper95                    |  0.715 | <= 0.5   |
|      0.95 | stratum:theta-cell:Foundation:1:-2.6:classifiedBandAccuracyLower95  |  0.823 | >= 0.9   |
|      0.95 | stratum:theta-cell:Foundation:2:-2.3:credibleCoverageLower95        |  0.459 | >= 0.85  |
|      0.95 | stratum:theta-cell:Foundation:2:-2.3:absoluteBiasUpper95            |  0.586 | <= 0.1   |
|      0.95 | stratum:theta-cell:Foundation:2:-2.3:rmseUpper95                    |  0.671 | <= 0.5   |
|      0.95 | stratum:theta-cell:Foundation:2:-2.3:classifiedBandAccuracyLower95  |  0.359 | >= 0.9   |
|      0.95 | stratum:theta-cell:Foundation:3:-2:credibleCoverageLower95          |  0.521 | >= 0.85  |
|      0.95 | stratum:theta-cell:Foundation:3:-2:absoluteBiasUpper95              |  0.581 | <= 0.1   |
|      0.95 | stratum:theta-cell:Foundation:3:-2:rmseUpper95                      |  0.684 | <= 0.5   |
|      0.95 | stratum:theta-cell:Foundation:3:-2:classifiedBandAccuracyLower95    |  0.000 | >= 0.9   |
|      0.95 | stratum:theta-cell:Foundation:4:-1.7:credibleCoverageLower95        |  0.651 | >= 0.85  |
|      0.95 | stratum:theta-cell:Foundation:4:-1.7:absoluteBiasUpper95            |  0.438 | <= 0.1   |
|      0.95 | stratum:theta-cell:Foundation:4:-1.7:rmseUpper95                    |  0.548 | <= 0.5   |
|      0.95 | stratum:theta-cell:Foundation:4:-1.7:classifiedBandAccuracyLower95  |  0.000 | >= 0.9   |
|      0.95 | stratum:theta-cell:Independent:0:-1.2:credibleCoverageLower95       |  0.742 | >= 0.85  |
|      0.95 | stratum:theta-cell:Independent:0:-1.2:absoluteBiasUpper95           |  0.351 | <= 0.1   |
...
|      0.95 | stratum:theta-cell:Independent:1:-0.6:absoluteBiasUpper95           |  0.239 | <= 0.1   |
|      0.95 | stratum:theta-cell:Independent:2:0:credibleCoverageUpper95          |  0.959 | <= 0.95  |
|      0.95 | stratum:theta-cell:Independent:3:0.6:absoluteBiasUpper95            |  0.254 | <= 0.1   |
|      0.95 | stratum:theta-cell:Independent:4:1.2:credibleCoverageLower95        |  0.761 | >= 0.85  |
|      0.95 | stratum:theta-cell:Independent:4:1.2:absoluteBiasUpper95            |  0.341 | <= 0.1   |
|      0.95 | stratum:theta-cell:Independent:4:1.2:rmseUpper95                    |  0.511 | <= 0.5   |
|      0.95 | stratum:theta-cell:Advanced:0:1.7:credibleCoverageLower95           |  0.635 | >= 0.85  |
|      0.95 | stratum:theta-cell:Advanced:0:1.7:absoluteBiasUpper95               |  0.475 | <= 0.1   |
|      0.95 | stratum:theta-cell:Advanced:0:1.7:rmseUpper95                       |  0.584 | <= 0.5   |
...
|      0.95 | stratum:theta-cell:Advanced:1:2:absoluteBiasUpper95                 |  0.517 | <= 0.1   |
|      0.95 | stratum:theta-cell:Advanced:1:2:rmseUpper95                         |  0.620 | <= 0.5   |
|      0.95 | stratum:theta-cell:Advanced:1:2:classifiedBandAccuracyLower95       |  0.000 | >= 0.9   |
|      0.95 | stratum:theta-cell:Advanced:2:2.3:credibleCoverageLower95           |  0.419 | >= 0.85  |
|      0.95 | stratum:theta-cell:Advanced:2:2.3:absoluteBiasUpper95               |  0.624 | <= 0.1   |
|      0.95 | stratum:theta-cell:Advanced:2:2.3:rmseUpper95                       |  0.712 | <= 0.5   |
|      0.95 | stratum:theta-cell:Advanced:2:2.3:classifiedBandAccuracyLower95     |  0.376 | >= 0.9   |
|      0.95 | stratum:theta-cell:Advanced:3:2.6:credibleCoverageLower95           |  0.390 | >= 0.85  |
|      0.95 | stratum:theta-cell:Advanced:3:2.6:absoluteBiasUpper95               |  0.658 | <= 0.1   |
...
|      0.95 | stratum:theta-cell:Advanced:4:2.9:absoluteBiasUpper95               |  0.722 | <= 0.1   |
|      0.95 | stratum:theta-cell:Advanced:4:2.9:rmseUpper95                       |  0.783 | <= 0.5   |
|      0.95 | stratum:cut-distance:NEAR_CUT:credibleCoverageLower95               |  0.729 | >= 0.85  |
|      0.95 | stratum:cut-distance:NEAR_CUT:confidentMisclassificationRateUpper95 |  0.063 | <= 0.01  |
|      0.95 | stratum:cut-distance:INTERIOR:credibleCoverageLower95               |  0.628 | >= 0.85  |
|      0.95 | stratum:cut-distance:INTERIOR:rmseUpper95                           |  0.597 | <= 0.5   |
