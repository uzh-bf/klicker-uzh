...
export type UpdateQuestionInstancesMutation = { __typename?: 'Mutation', updateQuestionInstances?: Array<{ __typename?: 'QuestionInstance', id: number, questionData: { __typename?: 'ChoicesQuestionData', id: number, name: string, type: QuestionType, content: string, pointsMultiplier?: number | null } | { __typename?: 'FreeTextQuestionData', id: number, name: string, type: QuestionType, content: string, pointsMultiplier?: number | null } | { __typename?: 'NumericalQuestionData', id: number, name: string, type: QuestionType, content: string, pointsMultiplier?: number | null } }> | null };
