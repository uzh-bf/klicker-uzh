...
export type GetFileUploadSasMutation = { __typename?: 'Mutation', getFileUploadSas?: { __typename?: 'FileUploadSAS', uploadURL: string, containerName: string, fileName: string } | null };
