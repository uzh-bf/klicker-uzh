...
export type CreateMicroSessionMutation = { __typename?: 'Mutation', createMicroSession?: { __typename?: 'MicroSession', id: string, name: string, displayName: string, description?: string | null, scheduledStartAt: any, scheduledEndAt: any, pointsMultiplier: number, course?: { __typename?: 'Course', id: string } | null, instances?: Array<{ __typename?: 'QuestionInstance', id: number, questionData?: { __typename?: 'ChoicesQuestionData', id: string, name: string } | { __typename?: 'ContentElementQData', id: string, name: string } | { __typename?: 'FlashcardElementQData', id: string, name: string } | { __typename?: 'FreeTextQuestionData', id: string, name: string } | { __typename?: 'NumericalQuestionData', id: string, name: string } | null }> | null } | null };
...
export type UpdateQuestionInstancesMutation = { __typename?: 'Mutation', updateQuestionInstances?: Array<{ __typename?: 'QuestionInstance', id: number, questionData?: { __typename?: 'ChoicesQuestionData', id: string, name: string, type: ElementType, content: string, pointsMultiplier?: number | null } | { __typename?: 'ContentElementQData', id: string, name: string, type: ElementType, content: string, pointsMultiplier?: number | null } | { __typename?: 'FlashcardElementQData', id: string, name: string, type: ElementType, content: string, pointsMultiplier?: number | null } | { __typename?: 'FreeTextQuestionData', id: string, name: string, type: ElementType, content: string, pointsMultiplier?: number | null } | { __typename?: 'NumericalQuestionData', id: string, name: string, type: ElementType, content: string, pointsMultiplier?: number | null } | null }> | null };
