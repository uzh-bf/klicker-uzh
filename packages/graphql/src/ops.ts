...
export type CheckPrivatePreviewAvailableQueryVariables = Exact<{ [key: string]: never; }>;


export type CheckPrivatePreviewAvailableQuery = { __typename?: 'Query', checkPrivatePreviewAvailable: boolean };

export type CheckPublicPreviewAvailableQueryVariables = Exact<{ [key: string]: never; }>;
...
export type UserProfileQuery = { __typename?: 'Query', userProfile?: { __typename?: 'User', id: string, email: string, sendProjectUpdates: boolean, shortname: string, locale: LocaleType, firstLogin: boolean, catalyst: boolean, catalystTier?: string | null, publicPreview: boolean, privatePreview: boolean } | null };
