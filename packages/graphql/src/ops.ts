...
export type GetParticipantDetailsQuery = { __typename?: 'Query', participantDetails?: { __typename?: 'ParticipantWithAchievements', participant: { __typename?: 'Participant', id: string, username: string, avatar?: string | null, avatarSettings?: any | null, level: number, xp: number, achievements?: Array<{ __typename?: 'ParticipantAchievementInstance', id: number, achievedAt: any, achievedCount: number, achievement: { __typename?: 'Achievement', id: number, name: string, description: string, icon: string, iconColor?: string | null } }> | null }, achievements: Array<{ __typename?: 'Achievement', id: number, name: string, description: string, icon: string, iconColor?: string | null }> } | null };
...
export type SelfQuery = { __typename?: 'Query', self?: { __typename?: 'Participant', id: string, username: string, avatar?: string | null, avatarSettings?: any | null, xp: number, level: number, levelData?: { __typename?: 'Level', id: number, nextLevel?: { __typename?: 'Level', id: number, index: number, requiredXp: number } | null } | null, achievements?: Array<{ __typename?: 'ParticipantAchievementInstance', id: number, achievedAt: any, achievedCount: number, achievement: { __typename?: 'Achievement', id: number, name: string, description: string, icon: string, iconColor?: string | null } }> | null } | null };
