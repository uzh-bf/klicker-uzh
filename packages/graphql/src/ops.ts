...
export type GetCourseQuizAnalyticsQuery = { __typename?: 'Query', getCourseQuizAnalytics?: { __typename?: 'CourseQuizAnalytics', name: string, totalParticipants: number, instanceFeedbacks: Array<{ __typename: 'InstanceFeedback', activityId: string, activityType: ActivityType, instanceId: number, instanceName: string, upvoteRate: number, downvoteRate: number }>, activityFeedbacks: Array<{ __typename: 'ActivityFeedback', activityId: string, activityType: ActivityType, activityName: string, upvoteRate: number, downvoteRate: number }> } | null };
