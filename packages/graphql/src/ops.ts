...
export type GetBookmarkedQuestionsQuery = { __typename?: 'Query', getBookmarkedQuestions?: Array<{ __typename?: 'QuestionStack', id: number, displayName?: string | null, elements?: Array<{ __typename?: 'StackElement', id: number, questionInstance?: { __typename?: 'QuestionInstance', id: number, questionData: { __typename?: 'ChoicesQuestionData', id: number, name: string, type: QuestionType } | { __typename?: 'FreeTextQuestionData', id: number, name: string, type: QuestionType } | { __typename?: 'NumericalQuestionData', id: number, name: string, type: QuestionType } } | null }> | null }> | null };
