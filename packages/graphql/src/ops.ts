...
export type GetUserScopeQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserScopeQuery = { __typename?: 'Query', userScope?: UserLoginScope | null };
...
export const GetUserScopeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetUserScope"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userScope"}}]}}]} as unknown as DocumentNode<GetUserScopeQuery, GetUserScopeQueryVariables>;
