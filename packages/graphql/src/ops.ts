...
export type UserProfileQuery = { __typename?: 'Query', userProfile?: { __typename?: 'User', id: string, email: string, shortname: string, locale: LocaleType } | null };
