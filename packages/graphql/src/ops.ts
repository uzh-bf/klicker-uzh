...
export type PublishLearningElementMutation = { __typename?: 'Mutation', publishLearningElement?: { __typename?: 'LearningElement', id: string, name: string, displayName: string, status: LearningElementStatus, stacksWithQuestions?: number | null } | null };
