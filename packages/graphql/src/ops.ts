...
export type MutationCreateCourseArgs = {
  ...
  description?: InputMaybe<Scalars['String']['input']>;
  displayName: Scalars['String']['input'];
  enableGroupCreation: Scalars['Boolean']['input'];
