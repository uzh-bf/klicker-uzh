...
export type WeekdayActivityAnalytics = {
  ...
  activityFriday: Scalars['Int']['output'];
  activityMonday: Scalars['Int']['output'];
  activitySaturday: Scalars['Int']['output'];
  activitySunday: Scalars['Int']['output'];
  activityThursday: Scalars['Int']['output'];
  activityTuesday: Scalars['Int']['output'];
  activityWednesday: Scalars['Int']['output'];
};
...
export type GetCourseActivityAnalyticsQuery = { __typename?: 'Query', getCourseActivityAnalytics?: { __typename?: 'CourseActivityAnalytics', name: string, totalParticipants: number, dailyActivity: Array<{ __typename?: 'ParticipantActivityTimestamp', date: any, activeParticipants: number }>, weeklyActivity: Array<{ __typename?: 'ParticipantActivityTimestamp', date: any, activeParticipants: number }>, activeDays: { __typename?: 'WeekdayActivityAnalytics', activityMonday: number, activityTuesday: number, activityWednesday: number, activityThursday: number, activityFriday: number, activitySaturday: number, activitySunday: number } } | null };
