...
export enum MicroLearningStatus {
  Draft = 'DRAFT',
  Published = 'PUBLISHED'
}
...
export type ParticipationsQuery = { __typename?: 'Query', participations?: Array<{ __typename?: 'Participation', id: number, completedMicroSessions: Array<string>, completedMicroLearnings: Array<string>, subscriptions?: Array<{ __typename?: 'PushSubscription', id: number, endpoint: string }> | null, course?: { __typename?: 'Course', id: string, displayName: string, startDate: any, endDate: any, description?: string | null, isGamificationEnabled: boolean, microSessions?: Array<{ __typename?: 'MicroSession', id: string, displayName: string, scheduledStartAt: any, scheduledEndAt: any }> | null, microLearnings?: Array<{ __typename?: 'MicroLearning', id: string, displayName: string, scheduledStartAt: any, scheduledEndAt: any }> | null, sessions?: Array<{ __typename?: 'Session', id: string, displayName: string, linkTo?: string | null }> | null } | null }> | null };
