...
export type GetUserFlashcardSetsQuery = { __typename?: 'Query', userFlashcardSets?: Array<{ __typename?: 'FlashcardSet', id: string, name: string, displayName: string, description?: string | null, status: FlashcardSetStatus, numOfFlashcards?: number | null, course?: { __typename?: 'Course', id: string, name: string, displayName: string } | null }> | null };
