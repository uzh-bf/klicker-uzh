...
export type ManualRandomGroupAssignmentsMutation = { __typename?: 'Mutation', manualRandomGroupAssignments?: { __typename?: 'Course', id: string, displayName: string, groupDeadlineDate?: any | null, participantGroups?: Array<{ __typename?: 'ParticipantGroup', id: string, name: string, code: number, averageMemberScore: number, groupActivityScore: number, participants?: Array<{ __typename?: 'Participant', id: string, username: string, score?: number | null, email?: string | null, avatar?: string | null }> | null }> | null } | null };
