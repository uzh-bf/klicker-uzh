...
export type OptionsCaseStudyInput = {
  answerCollectionId?: InputMaybe<Scalars['Int']['input']>;
...
export type SelectionAnswerCollection = {
  __typename?: 'SelectionAnswerCollection';
  entries?: Maybe<Array<SelectionAnswerCollectionEntry>>;
  id: Scalars['Int']['output'];
};

export type SelectionAnswerCollectionEntry = {
  __typename?: 'SelectionAnswerCollectionEntry';
  id: Scalars['Int']['output'];
  value: Scalars['String']['output'];
};
...
export type SelectionElementOptions = {
  ...
  answerCollection?: Maybe<SelectionAnswerCollection>;
