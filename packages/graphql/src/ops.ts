...
export type FlashcardElementResult = {
  count: Scalars['Int']['output'];
  value: FlashcardCorrectness;
};

export type FlashcardElementResults = {
  studentGrading: Array<FlashcardElementResult>;
  totalAnswers: Scalars['Int']['output'];
};
