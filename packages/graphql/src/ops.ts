...
export type GetUserCoursesQuery = { __typename?: 'Query', userCourses?: Array<{ __typename?: 'Course', id: string, name: string, displayName: string, color: string, pinCode?: number | null, isArchived: boolean, isGamificationEnabled: boolean, isGroupCreationEnabled: boolean, description?: string | null, createdAt?: any | null, updatedAt?: any | null }> | null };
