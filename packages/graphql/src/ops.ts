...
export type PublishMicroLearningMutation = { __typename?: 'Mutation', publishMicroLearning?: { __typename?: 'MicroLearning', id: string, name: string, displayName: string, status: PublicationStatus, numOfStacks?: number | null } | null };
