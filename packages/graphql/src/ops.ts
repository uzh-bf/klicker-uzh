...
export type GetCourseSummaryQuery = { __typename?: 'Query', getCourseSummary?: { __typename?: 'CourseSummary', numOfLiveQuizzes: number, numOfPracticeQuizzes: number, numOfMicroLearnings: number, numOfGroupActivities: number, numOfLeaderboardEntries: number, numOfParticipantGroups: number } | null };
