...
export type ActivityErrorRate = {
  __typename?: 'ActivityErrorRate';
...
export type CoursePerformanceAnalytics = {
  ...
  activityErrorRates: Array<ActivityErrorRate>;
  activityProgresses: Array<ActivityProgress>;
  instanceErrorRates: Array<InstanceErrorRate>;
  name: Scalars['String']['output'];
  totalParticipants: Scalars['Int']['output'];
};
...
export type InstanceErrorRate = {
  __typename?: 'InstanceErrorRate';
  correctRate: Scalars['Float']['output'];
...
export type GetCoursePerformanceAnalyticsQuery = { __typename?: 'Query', getCoursePerformanceAnalytics?: { __typename?: 'CoursePerformanceAnalytics', name: string, totalParticipants: number, activityProgresses: Array<{ __typename?: 'ActivityProgress', activityName: string, activityType: ActivityType, startedCount: number, completedCount: number, repeatedCount?: number | null }>, activityErrorRates: Array<{ __typename?: 'ActivityErrorRate', activityName: string, activityType: ActivityType, errorRate: number, partialRate: number, correctRate: number }>, instanceErrorRates: Array<{ __typename?: 'InstanceErrorRate', elementName: string, elementType: ElementType, errorRate: number, partialRate: number, correctRate: number }> } | null };
