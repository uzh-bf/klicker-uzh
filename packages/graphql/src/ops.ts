...
export type GetAnswerCollectionsQuery = { __typename?: 'Query', getAnswerCollections?: { __typename: 'UserAnswerCollections', answerCollections: Array<{ __typename?: 'AnswerCollection', id: number, name: string, access: CollectionAccess, description: string, entries?: Array<{ __typename?: 'AnswerCollectionEntry', id: number, value: string }> | null }>, sharedCollections: Array<{ __typename?: 'AnswerCollection', id: number, name: string, access: CollectionAccess, description: string, ownerShortname?: string | null, entries?: Array<{ __typename?: 'AnswerCollectionEntry', id: number, value: string }> | null }>, requestedCollections: Array<{ __typename?: 'AnswerCollection', id: number, name: string, access: CollectionAccess, description: string, ownerShortname?: string | null }> } | null };
