...
export type CourseQuizAnalytics = {
  __typename?: 'CourseQuizAnalytics';
...
export type Query = {
  ...
  getCourseQuizAnalytics?: Maybe<CourseQuizAnalytics>;
...
export type QueryGetCourseQuizAnalyticsArgs = {
  courseId: Scalars['String']['input'];
};
...
export type GetCourseQuizAnalyticsQueryVariables = Exact<{
  courseId: Scalars['String']['input'];
}>;


export type GetCourseQuizAnalyticsQuery = { __typename?: 'Query', getCourseQuizAnalytics?: { __typename?: 'CourseQuizAnalytics', name: string, totalParticipants: number, instanceFeedbacks: Array<{ __typename: 'InstanceFeedback', id: number, activityType: ActivityType, instanceName: string, instanceType: ElementType, upvoteRate: number, downvoteRate: number, feedbackCount: number }>, activityFeedbacks: Array<{ __typename: 'ActivityFeedback', id: string, activityType: ActivityType, activityName: string, upvoteRate: number, downvoteRate: number, feedbackCount: number }> } | null };
