...
export type AnswerCollection = {
  ...
  entries: Array<AnswerCollectionEntry>;
  id: Scalars['Int']['output'];
  name: Scalars['String']['output'];
...
export type CreateAnswerCollectionMutation = { __typename?: 'Mutation', createAnswerCollection?: { __typename?: 'AnswerCollection', id: number, name: string, access: CollectionAccess, description: string, ownerShortname?: string | null, entries: Array<{ __typename?: 'AnswerCollectionEntry', id: number, value: string }> } | null };
