...
describe('Unit tests covering the creation of derived permissions', () => {
  ...
  // #region
  // TODO: Verify that owner permissions on a catalog collection are correctly copied into the derived permissions table
  ...
  // TODO: Verify that on removal of direct group permissions, individual derived permissions are also removed
  // TODO: Verify that on removal of direct individual permissions, corresponding derived permissions are also removed
  // TODO: Verify that on removal of direct individual permissions, remaining group permissions take effect (also if lower)
  // TODO: Verify that on removal of direct group permissions, remaining individual permissions take effect (also if lower)
  // #endregion

  // ! Element permissions tests
  // #region
  // TODO: Verify that owner permissions on an element are correctly copied into the derived permissions table
  // TODO: Verify that other direct permissions are correctly copied into the derived permissions table
  // TODO: Verify that when passing a userId only the corresponding derived permissions are updated
  ...
  // ! Activity -> Element
  // TODO: Verify that minimum required permissions are correctly derived from activities for individual users
  // --> according to table in DOCX
  // TODO: Verify that propagated permissions from activities are correctly derived for individual users
  // --> according to table in DOCX
  // TODO: Verify that minimum required permissions are correctly derived from activities for user groups
  // --> according to table in DOCX
  // TODO: Verify that propagated permissions from activities are correctly derived for user groups
  // --> according to table in DOCX
  // TODO: Verify that derived permissions from activity take precedence over direct permissions (if higher)
  // TODO: Verify that direct permissions on element take precedence over derived permissions from activity (if higher)
  // TODO: Verify that derived group permissions from activity take precedence over direct permissions (if higher)
  // TODO: Verify that direct group permissions take precedence over derived permissions from activity (if higher)
  // TODO: Verify that individual permissions are correctly updated in the presence of direct group permissions when passing userId parameter
  // TODO: Verify that individual permissions are correctly updated in the presence of derived group permissions when passing userId parameter

  // ! Element -> Answer Collection
  // TODO: Verify that all users with permission on element automatically get derived access on linked answer collections (derived permissions always READ)
  // TODO: Verify that direct permissions on answer collections still take precedence over derived permissions (if equal or higher - always the case here)
  // TODO: Verify that access to answer collections is revoked when removing access to the element (and no direct permission on resource exists)
  // TODO: Verify that access to answer collections is revoked when removing group access to the element (and no direct permission on resource exists)
  // TODO: Verify that access to answer collection persists on removal of group access to element if an individual permission exists
  // TODO: Verify that changing the answer collection linked to an element updates the derived permissions
  // #endregion
