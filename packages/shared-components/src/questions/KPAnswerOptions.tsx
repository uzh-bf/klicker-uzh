          ...
          >
            ...
            <div className="flex flex-row gap-2">
              <Button
                className={{
                  root: twMerge(
                    'p-0! h-9 w-9 border-slate-400 disabled:opacity-90',
                    value?.[choice.ix] === true &&
                      'bg-primary-20 border-primary-100 hover:bg-primary-20 disabled:hover:bg-primary-20 cursor-not-allowed',
                    value?.[choice.ix] === false &&
                      'disabled:bg-accent disabled:hover:bg-accent cursor-not-allowed disabled:opacity-90',
              ...
              <Button
                className={{
                  root: twMerge(
                    'h-9 w-9 border-slate-400 disabled:opacity-90',
                    value?.[choice.ix] === false &&
                      'bg-primary-20 border-primary-100 hover:bg-primary-20 disabled:hover:bg-primary-20 cursor-not-allowed',
                    value?.[choice.ix] === true &&
                      'disabled:bg-accent disabled:hover:bg-accent cursor-not-allowed disabled:opacity-90',
