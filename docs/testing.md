...
| Live Quiz response mode or evaluation export UI                      | Playwright e2e plus a real browser pass                                                         | verify mode selection/locking, the student privacy notice, and the ended-quiz export action                                               |
