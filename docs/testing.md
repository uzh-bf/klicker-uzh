...
global cleanup and seed only for a local host-launcher run; it is disabled in
CI. Individual specs still own their fixture writes and cleanup. Use this only
