...
The A1-A5/B1 slices now implement the identity and finalization contract locally. Correlated publication remains disabled until B2, finite retention, and integrated/browser verification are complete.
