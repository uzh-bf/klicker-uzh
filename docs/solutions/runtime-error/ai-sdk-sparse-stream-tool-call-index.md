---
type: Solution
title: Guard OpenAI-Compatible Streams Against Sparse Tool-Call Indices
description: Keep the public AI SDK stream conversion path healthy when an upstream tool-call index starts at one.
module: chat
date: 2026-08-09
...
(`project/2026-08-09-vorkurs-chatbot-sdk-fix-plan.md:40`).
...
(`project/2026-08-09-vorkurs-chatbot-sdk-fix-plan.md:174`).
...
terminal `finish` parts (`apps/chat/test/openai-chat-streaming.test.ts:14`).
...
test remains a separate release gate (`.agents/skills/klicker-testing-verification/SKILL.md:24`).
