...
| `kb-auto-graph-preparation` | Scheduled graph preparation (no consumer yet)           | `false`  | No automatic graph build is admitted; lecturer-requested builds are unaffected                                                       |
