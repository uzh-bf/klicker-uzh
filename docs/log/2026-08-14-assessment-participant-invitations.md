...
- **Privacy**: Browser screenshots were inspected locally but excluded from the public repository because the seeded assessment course displays participant email addresses. The draft PR records the verified states without publishing that seed data.
